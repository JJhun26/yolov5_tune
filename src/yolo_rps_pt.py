...
# TODO: 커스텀 모델 로드
model_path = os.path.abspath("/home/intel/yolo_finetune/d020rs-yolov5-rock-paper-scissors-JJhun26/src/yolov5/runs/train/rps_yolov5m_noipex/weights/best.pt")
model = torch.hub.load("ultralytics/yolov5", "custom", path=model_path)

# TODO: Label 로드
# label_path = os.path.abspath("/home/intel/repo/d020rs-yolov5-rock-paper-scissors-JJhun26/src/rps_model.names.json")
